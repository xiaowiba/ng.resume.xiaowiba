ngrAdminApp.controller('detailController', function ($rootScope, $scope, $filter, $http, $state, $sce, $location) {
    ...
    $scope.initData = function () {
        ...
        $http.post('/admin/detail/detail', param).success(function (data) {
            NProgress.done();
            ...
            $scope.markdown = data.data.markdown;

            $scope.initEditorMd($scope.markdown);
    ...
    $scope.update = function () {
        ...
        if($scope.cname === '' || $scope.duty === '' || $('#stime').val() === '' || $('#etime').val() === '' || $scope.duration === '' || $scope.content === '' || $scope.sort === ''){
        ...
        $http.post('/admin/detail/update', param).success(function (data) {
            NProgress.done();
